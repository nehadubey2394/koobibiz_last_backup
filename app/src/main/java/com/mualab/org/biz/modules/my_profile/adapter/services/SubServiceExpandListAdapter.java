...
public class SubServiceExpandListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ArtistServices> childtems;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (parentArrayList.size()!=0){
            try {
                ...
                ArrayList<ArtistServices> arrayList = services.artistservices;
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final ArtistServices subServices = (ArtistServices) getChild(groupPosition, childPosition);
