...
public class ChangeServiceDetailActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                switch (keyField) {
                    case "serviceName":
                        ...
                        if (!serviceName.isEmpty()) {
                            ...
                            MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please enter service name");
                        ...
                        switch (bookingType) {
                            case "Incall":
                                ...
                                if (!inCallPrice.isEmpty() && !inCallPrice.equals(".") && !inCallPrice.equals("..")){
                                    ...
                                    if (incallP!=0) {
                                        ...
                                        MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please enter incall price");
                            ...
                            case "Outcall":
                                ...
                                if (!outCallPrice.isEmpty() && !outCallPrice.equals(".") && !outCallPrice.equals("..")){
                                    ...
                                    if (inoutP!=0) {
                                        ...
                                        MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please enter outcall price");
                            ...
                            case "Both":
                                ...
                                if (outCallPrice.isEmpty() || inCallPrice.isEmpty())
                                    MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please enter service price");
                                else {
                                    intent.putExtra("outCallPrice", outCallPrice);
                                    intent.putExtra("inCallPrice", inCallPrice);
                                    intent.putExtra("bookingType", bookingType);
                    ...
                    case "serviceDesc":
                        ...
                        if (!serviceDesc.isEmpty()) {
                            ...
                            MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please enter service description");
                        break;
                    ...
                    case "bookingType":
                        ...
                        if (!bookingType.isEmpty()) {
                            ...
                            MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please select booking type");
                    ...
                    case "complieTime":
                        ...
                        if (!complieTime.isEmpty() && !complieTime.equals("00:00")) {
                            ...
                            MyToast.getInstance(ChangeServiceDetailActivity.this).showDasuAlert("Please select completion time");
