package com.mualab.org.biz.task;
...
import com.mualab.org.biz.application.VolleyRequest.AppHelper;
import com.mualab.org.biz.application.VolleyRequest.VolleyMultipartRequest;
import com.mualab.org.biz.application.VolleyRequest.VolleySingleton;
import com.mualab.org.biz.dialogs.MDialog;
        ...
        StringRequest stringRequest = new StringRequest(Method, API.BASE_URL + url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(DEBUG){
                            System.out.println("API Name:#" + API.BASE_URL + url);
