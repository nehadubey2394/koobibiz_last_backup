...
public class AddAddressActivity extends AppCompatActivity {
    ...
    private String country,state, city, stAddress1, stAddress2, postalCode, placeName;// fullAddress;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_save:
                ...
                if(validateAddress()){
                    if((placeName.contains("S")|| placeName.contains("N") || placeName.contains("E"))
                            && placeName.contains("°"))
                        placeName = "";
    ...
    private boolean validateAddress(){
        return !(TextUtils.isEmpty(city) //|| TextUtils.isEmpty(country) || TextUtils.isEmpty(state)
