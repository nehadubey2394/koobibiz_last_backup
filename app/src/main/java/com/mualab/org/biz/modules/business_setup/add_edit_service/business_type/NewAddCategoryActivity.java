...
public class NewAddCategoryActivity extends AppCompatActivity implements View.OnClickListener{
    private  String TAG = NewAddCategoryActivity.class.getName();
    ...
    private void init() {
        ...
        tvHeaderTitle.setText(getString(R.string.add_category));

        LinearLayoutManager layoutManager = new LinearLayoutManager(NewAddCategoryActivity.this, LinearLayoutManager.VERTICAL, false);
        listViewServices.setLayoutManager(layoutManager);

        adapter = new AllCategoryListAdapter(NewAddCategoryActivity.this,allCategoryList,
        ...
        KeyboardUtil.hideKeyboard(searchview, NewAddCategoryActivity.this);
        ...
        switch (view.getId()){
            case R.id.btnContinue:
                ...
                if (!searchText.equals(""))
                    ...
                    MyToast.getInstance(NewAddCategoryActivity.this).showDasuAlert("Please select any category.");
            ...
            case R.id.btnAddNewCategory:
                if (!searchText.equals(""))
                    if (searchText.length() <= 20)
                        ...
                        MyToast.getInstance(NewAddCategoryActivity.this).showDasuAlert("Maximum character limit should be 20.");
    ...
    private void getAllCategory() {
        ...
        if (!ConnectionDetector.isConnected()) {
            new NoConnectionDialog(NewAddCategoryActivity.this, new NoConnectionDialog.Listner() {
                @Override
        ...
        HttpTask task = new HttpTask(new HttpTask.Builder(NewAddCategoryActivity.this,
            ...
            public void ErrorListener(VolleyError error) {
                ...
                try {
                    ...
                    if (helper.error_Messages(error).contains("Session")) {
                        ...
                        MyToast.getInstance(NewAddCategoryActivity.this).showDasuAlert(helper.error_Messages(error));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            public void onResponse(String response, String apiName) {
                try {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        MyToast.getInstance(NewAddCategoryActivity.this).showDasuAlert("Category added successfully");

                        EditText et = searchview.findViewById(R.id.search_src_text);
                        et.setText("");
                        searchview.setQueryHint("Search...");

                        Intent intent = new Intent(NewAddCategoryActivity.this,NewAddedCategoryTypeActivity.class);
                        ...
                        MyToast.getInstance(NewAddCategoryActivity.this).showDasuAlert(message);
                    }
                    //    pbLoder.setVisibility(View.GONE);
