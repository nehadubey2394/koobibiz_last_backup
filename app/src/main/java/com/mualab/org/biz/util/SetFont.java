...
public class SetFont {
    ...
    public static void setfontRagular(TextView view, Context context) {
        ...
        Typeface face = Typeface.createFromAsset(context.getResources().getAssets(), "font/Raleway-Regular.ttf");
        view.setTypeface(face);
    }

    public static void setfontMedium(TextView view, Context context) {

        Typeface face = Typeface.createFromAsset(context.getResources().getAssets(), "font/Raleway_Medium.ttf");
        view.setTypeface(face);
    }
