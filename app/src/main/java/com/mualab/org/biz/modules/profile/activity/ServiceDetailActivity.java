...
public class ServiceDetailActivity extends AppCompatActivity {
    private TextView tvServiceName,tvOutCallPrice,tvInCallPrice,tvServiceDesc,tvBusinessTypeName,
            tvCompileTime,tvCategoryName,tvBookingType;
    ...
    private void initView(){
        ...
        tvOutCallPrice = findViewById(R.id.tvOutCallPrice);
        tvServiceDesc = findViewById(R.id.tvServiceDesc);
        tvInCallPrice = findViewById(R.id.tvInCallPrice);
        tvCompileTime = findViewById(R.id.tvCompileTime);
        tvBusinessTypeName = findViewById(R.id.tvBusinessTypeName);
