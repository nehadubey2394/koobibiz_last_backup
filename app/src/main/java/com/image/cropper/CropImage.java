...
public final class CropImage {
    ...
    /**
     * The request code used to start pick image modules to be used on result to identify the this specific request.
     */
    ...
    /**
     * Start an modules to get image for cropping using chooser intent that will have all the available
     ...
     *
     * @param activity the modules to be used to start modules from
     */
     ...
     *
     * @param context used to access Android APIs, like content resolve, it is your modules/fragment/widget.
     */
     ...
     * @param includeDocuments if to include KitKat documents modules containing all sources
     */
     ...
     *
     * @param context used to access Android APIs, like content resolve, it is your modules/fragment/widget.
     * @param data    the returned data of the  modules result
     */
    ...
    /**
     * Get {@link CropImageActivity} result data object for crop image modules started using {@link #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Get {@link CropImageActivity} intent to start the modules.
         */
         ...
         *
         * @param activity modules to receive result
         */
        ...
        /**
         * if the result of crop image modules should not save the cropped image bitmap.<br>
